...
{
    public partial class UcNdsInfo
    {
        public static readonly RoutedEvent CmdScanButtonEvent = EventManager.RegisterRoutedEvent("CmdScanButtonEvent", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(UcNdsInfo));
        ...
        {
            NdsUpdate parent = Util.TryFindParent<NdsUpdate>(this);
